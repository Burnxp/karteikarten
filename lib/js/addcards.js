...
const divItemF1 = document.createElement('div');
divItemF1.className = className;
...
Object.keys(cardStorage).forEach(key => {
    ...
    divItemF1.appendChild(listItem);
});

// Füge das div-Element zur Liste hinzu
cardList.appendChild(divItemF1);
}
