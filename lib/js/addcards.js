...
for (let key in cardStorageF2) {
  // Erstelle ein neues Listenelement
  const listItem = document.createElement("li");
  listItem.classList.add('cardList2');
  listItem.textContent = `${key} - ${cardStorageF2[key]}`;
...
for (let key in cardStorageF3) {
  // Erstelle ein neues Listenelement
  const listItem = document.createElement("li");
  listItem.classList.add('cardList3');
  listItem.textContent = `${key} - ${cardStorageF3[key]}`;
...
/* function allCardsLoad(){
  ...
  if (keys.length === 0) {
    ...
    document.querySelectorAll(".keyDelete").forEach(el => el.style.display = "none");
    document.querySelectorAll(".cardVerzeichnis").forEach(el => el.style.display = "none");
  } else {
    // Zeige die .keyDelete-Elemente, wenn passende Schlüssel gefunden werden
    document.querySelectorAll(".keyDelete").forEach(el => el.style.display = "block");
    document.querySelectorAll(".cardVerzeichnis").forEach(el => el.style.display = "block");
  }
      keys.forEach(key => {
